...
# ==================================================================================================
# 7. FIND A1 TRAIN / TEST CSVs
# ==================================================================================================

TRAINING_METADATA_CSV = find_exact_file(
    "Patient_24_A1_training_metadata.csv"
)

TESTING_METADATA_CSV = find_exact_file(
    "Patient_24_A1_blinded_test_labels.csv"
)

if TRAINING_METADATA_CSV is None:
    raise FileNotFoundError(
        "Could not find Patient_24_A1_training_metadata.csv in Google Drive."
    )

if TESTING_METADATA_CSV is None:
    raise FileNotFoundError(
        "Could not find Patient_24_A1_blinded_test_labels.csv in Google Drive."
    )
...
EXISTING_LORA_TRAIN_SPLIT = find_exact_file(
    "Patient_24_A1_LoRA_actual_train.csv"
)

EXISTING_LORA_VALIDATION_SPLIT = find_exact_file(
    "Patient_24_A1_LoRA_validation.csv"
)
...
OUTPUT_ROOT = os.path.join(
    DRIVE_ROOT,
    "Patient_24_A1_MedGemma4B_QLoRA_r8_a16_50epochs_patience7",
)
...
TRAIN_SPLIT_CSV = os.path.join(
    OUTPUT_ROOT,
    "Patient_24_A1_QLoRA_actual_train.csv",
)

VALIDATION_SPLIT_CSV = os.path.join(
    OUTPUT_ROOT,
    "Patient_24_A1_QLoRA_validation.csv",
)

TRAINING_HISTORY_CSV = os.path.join(
    OUTPUT_ROOT,
    "Patient_24_A1_QLoRA_training_history.csv",
)

FINAL_PREDICTIONS_CSV = os.path.join(
    OUTPUT_ROOT,
    "Patient_24_A1_QLoRA_final_test_predictions.csv",
)

FINAL_METRICS_JSON = os.path.join(
    OUTPUT_ROOT,
    "Patient_24_A1_QLoRA_final_metrics.json",
)

EXPERIMENT_CONFIG_JSON = os.path.join(
    OUTPUT_ROOT,
    "Patient_24_A1_QLoRA_experiment_config.json",
)

TARGET_MODULES_TXT = os.path.join(
    OUTPUT_ROOT,
    "Patient_24_A1_QLoRA_target_modules.txt",
)

CONFUSION_MATRIX_CSV = os.path.join(
    OUTPUT_ROOT,
    "Patient_24_A1_QLoRA_confusion_matrix.csv",
)
...
# ==================================================================================================
# 11. EXACT SYSTEM PROMPT FROM PATIENT 24 A1 LoRA
# DO NOT CHANGE
# ==================================================================================================
...
# ==================================================================================================
# 12. EXACT PATIENT 24 A1 USER PROMPT PROVIDED BY THE USER
# DO NOT CHANGE
# ==================================================================================================
...
if (
    ...
    (
        ...
        "Existing Patient 24 A1 LoRA actual training split",
        "train",
    )
    ...
    (
        ...
        "Existing Patient 24 A1 LoRA validation split",
        "train",
    )
...
print("\n" + "=" * 100)
print("STARTING PATIENT 24 A1 MEDGEMMA-4B QLoRA TRAINING")
print("=" * 100)
...
print("\n" + "=" * 100)
print("FINAL PATIENT 24 A1 BLINDED TEST")
print("=" * 100)
...
print("\n" + "=" * 100)
print("PATIENT 24 A1 MEDGEMMA-4B QLoRA EXPERIMENT COMPLETE")
print("=" * 100)